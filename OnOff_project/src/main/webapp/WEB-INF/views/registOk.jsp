...
<!-- Navigation End  -->
      ...
      <div class="container">
         <div class="col-md-12">
            <div class="row">
               <div><br/><br/></div>
               <div style="font-size:40pt;color:black;">저희 <span style="color:#da0833;font-weight:bold;">ON&OFF</span>에 가입해주셔서 감사합니다 :)</div>
               <div><br/><br/></div>
               
               <div class="row">
                  <input type="button" class="btn brows-btn" value="로그인 페이지로 이동" onclick="location.href='login.do'"/>      
               </div>
